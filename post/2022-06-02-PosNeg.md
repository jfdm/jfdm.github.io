...
If not, then check else down the list, as we are dealing with lists not sets, so the key might be used elsewhere in the list...please don't hate me it is the truth!
